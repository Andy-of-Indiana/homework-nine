    ...
    <section class="homeBG">
      <nav>
        <div class="lineWhite">
          ...
          <div class="linksWhite">
            ...
            <p>|</p>
            <a id="aboutPage" href="#">about</a>
            <p>|</p>
            <a id="tourPage" href="#">tours</a>
            <p>|</p>
            <a id="specialOfferPage" href="#">special offer</a>
            <p>|</p>
            <a id="blogPage" href="#">blog</a>
            <p>|</p>
            <a id="contactPage" href="#">contact</a>
          </div>
        </div>
      </nav>
      ...
      <div class="homeTitle">
        ...
        <div class="buttonSquare">
          <a id="tourPage" href="#">READ MORE</a>
        </div>
      </div>
    </section>
    ...
    <section class="homeBookingLinks">
      <div class="homeTour img1">
        ...
        <div class="circleButton">
          <a id="tourIsraelPage" href="#">LEARN MORE</a>
        </div>
      </div>
      <div class="homeTour img2">
        ...
        <h2>from $1500</h2>
        <div class="circleButton">
          <a id="toursUSAPage" href="#">LEARN MORE</a>
        </div>
      </div>
      <div class="homeTour img3">
        ...
        <h2>from $1800</h2>
        <div class="circleButton">
          <a id="toursAustrailiaPage" href="#">LEARN MORE</a>
        </div>
      </div>
    </section>
